...
# Strategy
The user may be interested in these intents: {intents}
Rationale: {rationale}

Leverage the following proven strategies, categorized by occupation, to inform your conversation flow:

For people who work outdoors or in nature (such as farmers, woodcutters, fishermen, horticulturists):
- Recommend: FindRestaurants, FindAttraction
- Rationale: These users often value relaxation and leisure experiences when off work.

For technology professionals (such as software engineers, data scientists, cybersecurity specialists, telecommunications technicians):
- Recommend: SearchHotel, FindRestaurants
- Rationale: Tech workers frequently travel for work and value reliable accommodations and good dining options.

For finance and insurance professionals (such as investment analysts, actuaries, financial advisors, insurance claims adjusters):
- Recommend: SearchHotel, FindRestaurants
- Rationale: These users may have business travel needs and typically prefer higher-end services.

For educators and trainers (such as school teachers, professors, vocational instructors, special education teachers):
- Recommend: FindRestaurants, FindEvents
- Rationale: Educators often enjoy social or cultural activities and group-friendly dining.

For healthcare and social work professionals (such as doctors, nurses, therapists, psychologists):
- Recommend: FindRestaurants, FindEvents
- Rationale: These users often seek stress relief through leisure activities and social events.

For creative professionals (such as actors, musicians, artists, writers):
- Recommend: FindEvents, FindRestaurants
                        ...
                        try:
                            agent_response = get_response(
                                ...
                                messages=[
                                    ...
                                    {
                                        "role": "user",
                                        "content": SALESAGENT_PROMPT_NO_STRATEGY.replace(
